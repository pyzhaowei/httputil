...
import com.shug.httputil.client.common.Utils;
...
public class HttpClientUtil{
	 ...
	 * @throws HttpProcessException 
	 */
	public static ResponseContent get(HttpClient client, String url, Header[] headers, HttpContext context, String encoding) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException
	 */
	public static ResponseContent get(HttpConfig config) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException 
	 */
	public static ResponseContent post(HttpClient client, String url, Header[] headers, Map<String,Object>parasMap, HttpContext context, String encoding) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException
	 */
	public static ResponseContent post(HttpConfig config) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException 
	 */
	public static ResponseContent put(HttpClient client, String url, Map<String,Object>parasMap,Header[] headers, HttpContext context,String encoding) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException
	 */
	public static ResponseContent put(HttpConfig config) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException 
	 */
	public static ResponseContent delete(HttpClient client, String url, Header[] headers, HttpContext context,String encoding) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException
	 */
	public static ResponseContent delete(HttpConfig config) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException 
	 */
	public static ResponseContent patch(HttpClient client, String url, Map<String,Object>parasMap, Header[] headers, HttpContext context,String encoding) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException
	 */
	public static ResponseContent patch(HttpConfig config) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException 
	 */
	public static ResponseContent head(HttpClient client, String url, Header[] headers, HttpContext context,String encoding) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException
	 */
	public static ResponseContent head(HttpConfig config) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException 
	 */
	public static ResponseContent options(HttpClient client, String url, Header[] headers, HttpContext context,String encoding) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException
	 */
	public static ResponseContent options(HttpConfig config) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException 
	 */
	public static ResponseContent trace(HttpClient client, String url, Header[] headers, HttpContext context, String encoding) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException
	 */
	public static ResponseContent trace(HttpConfig config) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException 
	 */
	public static ResponseContent upload(HttpClient client, String url, Header[] headers, HttpContext context) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException 
	 */
	public static ResponseContent upload(HttpConfig config) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException
	 */
	public static ResponseContent send(HttpConfig config) throws HttpProcessException {
		return fmt2Content(execute(config), config.outenc());
	}
	 ...
	 * @throws HttpProcessException
	 */
	private static ResponseContent fmt2Content(HttpResponse resp, String encoding) throws HttpProcessException {
		ResponseContent content= null;
		try {
			if (resp.getEntity() != null) {
				content = new ResponseContent.Builder()
						.encoding(encoding)
						.contentType(getResponseContentType(resp.getEntity(), ""))
						.statusCode(resp.getStatusLine().getStatusCode())
						.contentBytes(EntityUtils.toByteArray(resp.getEntity()))
						.build();

				// 按指定编码转换结果实体为String类型
				Utils.info(content.getContent());
			}
			EntityUtils.consume(resp.getEntity());
		} catch (IOException e) {
			throw new HttpProcessException(e);
	 ...
	 * @return
	 */
	private static String getResponseContentType(HttpEntity entity, String def) {
